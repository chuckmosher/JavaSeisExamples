...
/**
 * Example class that creates a JavaSeis CDP ordered dataset and writes
 * random numbers. No trace headers are written in this example.
 *
...
public class ExampleCreateRandomFile {
	...
	public static void main (String[] args)throws SeisException  {
		...
		GridDefinition grid = GridDefinition.standardGrid( GridDefinition.CDP, size, lorigins, ldeltas,
				origins, deltas );
    ...
    float[] trc = new float[size[0]];
		...
		sio.close();
                ...
                // Clean up.
                // OOPS - another test requires the output from this one.
                // Seisio.delete(path, new String[0]);
