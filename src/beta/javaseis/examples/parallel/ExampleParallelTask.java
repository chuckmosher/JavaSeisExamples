package beta.javaseis.examples.parallel;
...
public class ExampleParallelTask {
   ...
   * 
   * @param args
   *          number of tasks to use as the first program argument (default 2).
  ...
  public static void main(String[] args) throws ExecutionException {
    ...
    new ParallelTaskExecutor(SimpleParallelTask.class, ntask);
