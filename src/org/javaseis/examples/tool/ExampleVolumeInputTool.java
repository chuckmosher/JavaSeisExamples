...
public class ExampleVolumeInputTool implements IVolumeTool {
  ...
  String inputFileSystem, inputFilePath;
  ...
  public void serialInit(ToolState toolState) throws SeisException {
    ...
    inputFilePath = toolState.getParameter(ToolState.INPUT_FILE_PATH);
    toolState.log("Input file path: " + inputFilePath);
  ...
  @Override
  public boolean outputVolume(IParallelContext pc, ToolState toolContext, ISeismicVolume output) throws SeisException {
  ...
  private void writeObject(ObjectOutputStream oos) throws IOException {
    ...
    oos.writeObject(inputFilePath);
    }

  private void readObject(ObjectInputStream ois) throws ClassNotFoundException, IOException {
    // default de-serialization
    inputFileSystem = (String)ois.readObject();
    inputFilePath = (String)ois.readObject();
  }
  ...
  public static void main(String[] args) {
    ...
    if (parms.getParameter(ToolState.INPUT_FILE_PATH) == "null") {
      parms.setParameter(ToolState.INPUT_FILE_PATH, "SegActiShotNo1.js");
    }
